...
var questions = [
    {
      enonce: "Qui a reçu la parole de Jéhovah vers 820 av.n.è ?",
      reponse: "Yoël. (Yoël 1:1)",
      indices: ["C'est un prophète de l'Ancien Testament.", "Son père s'appelle Pethouël."]
    },
    {
      enonce: "Dans le livre de Yoël, Quels insectes ont dévasté les cultures ? ",
      reponse: "Sauterelles (Yoël 1:4)",
      indices: ["Ces fléaux sont connus pour dévorer les cultures.", "Ils viennent dans un ordre dévastateur, laissant peu derrière eux."]
    },
    {
      enonce: "Dans le livre de Yoël, Quel arbre est spécifiquement mentionné comme endommagé ?",
      reponse: "Figuier. (Yoël 1:4)",
      indices: ["Arbre fruitier spécifiquement touché.", "Destruction complète décrite."]
    },
    {
      enonce: "Dans le livre de Yoël, Pourquoi les prêtres sont-ils en deuil ?",
      reponse: "Le Nil ou l'Amazone",
      indices: ["En Afrique ou en Amérique du Sud.", "Un débat existe sur le vrai gagnant."]
    },
    {
      enonce: "Dans le livre de Yoël, Quel est l'animal le plus rapide sur terre ?",
      reponse: "Guépard",
