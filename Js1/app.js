...
// .pauseFor(1800)
// .changeDelay(20)
// .typeString('Moi c\'est GianniEnnio')
// .pauseFor(300)
// .typeString('<strong>, Poète Amateur</strong> !')
// .pauseFor(1000)
// .deleteChars(15)
// .typeString('<span style="color: #27ae60;"> Vous trouverez ici des poemes:</span> !')
// .pauseFor(1000)
// .deleteChars(32)
// .typeString('<span style="color: #EA39ff;"> Lyriques </span> !')
// .pauseFor(1000)
// .deleteChars(12)
// .typeString('<span style="color: midnightblue;"> Sonnets </span> !')
// .pauseFor(1000)
// .deleteChars(10)
// .typeString('<span style="color: #ff6910;"> haïku </span> !')
// .deleteChars(10)
// .typeString('<span style="color: #ff6910;"> Ballade </span> !')
// .deleteChars(11)
// .typeString('<span style="color: #ff6910;"> Vers libre </span> !')
// .deleteChars(17)
// .typeString('<span style="color: #ff6910;"> Laisses vous importer </span> !')
// .start()
...
function ajusterTailleTexte(taille) {
    var texte = document.getElementById('texteAjustable');
    texte.style.fontSize = taille + 'px';
}
function ajusterBordure(taille) {
    var conteneur = document.getElementById('conteneurTexte');
    conteneur.style.borderWidth = taille + 'px';
}
